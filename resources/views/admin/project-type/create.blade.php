    ...
    <div class="mt-16 py-8">
        <div class="p-6 text-gray-900">
            <div class="max-w-md mx-auto bg-gray-50 dark:bg-gray-800 p-6 shadow-lg rounded-lg">
                <h1 class="text-2xl text-gray-900 dark:text-white font-bold mb-4">เพิ่มประเภทโครงงานวิจัย</h1>
                @if ($errors->any())
                    <div class="mb-4">
                ...
                <form action="{{ route('admin.project-type.store') }}" method="POST" class="max-w-sm mx-auto">
                    @csrf
                    ...
                    <div class="flex">
                        ...
                        <input type="text" id="name" name="name"
                            ...
                            placeholder="เช่น Web Development" required value="{{ old('name') }}">
                    </div>
                    ...
                    <div class="mt-4 flex justify-end">
                        ...
                        <a class="button px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700"
                            href="{{ route('admin.project-type.index') }}"
