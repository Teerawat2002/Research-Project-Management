    ...
    <div class="mt-16 py-8">
        <div class="p-6 text-gray-900">
            <div class="max-w-md mx-auto bg-gray-50 dark:bg-gray-800 p-6 shadow-lg rounded-lg">
                <h1 class="text-2xl text-gray-900 dark:text-white font-bold mb-4">เพิ่มหัวข้อย่อย</h1>
                ...
                <form action="{{ route('admin.topic.subsubtopic.store') }}" method="POST">
                    @csrf
                    ...
                    <!-- ใส่ชื่อหัวข้อ -->
                    <label for="stopic_id"
                        class="block text-sm font-medium text-gray-700 dark:text-gray-300">เลือกหัวข้อรอง</label>
                    <select name="stopic_id" id="stopic_id"
                        ...
                        @foreach ($sub_topics as $sub_topics)
                    ...
                    <div class="mt-4 flex justify-end">
                        <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 mr-4">
                            บันทึก
                        </button>
                        <a class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700" href="{{ route('admin.topic.subsubtopic.index') }}">
                            ยกเลิก
                        </a>
                    </div>
                </form>
