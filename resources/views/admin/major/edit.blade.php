        ...
        <div class="max-w-md mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-50 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="text-2xl text-gray-900 dark:text-white font-bold mb-4">แก้ข้อมูลสาขาวิชา</h1>
                    ...
                    <form action="{{ route('admin.major.update', $major->id) }}" method="POST" class="max-w-sm mx-auto">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="flex">
                            ...
                            <input type="text" id="m_name" name="m_name"
                                ...
                                placeholder="เช่น Computer Science" required value="{{ old('m_name', $major->m_name) }}">
                        </div>
