                                    ...
                                    @forelse($revisions as $revision)
                                        <tr
                                            ...
                                            @switch($revision->status)
                                                @case(1)
                                                    <span
                                                        class="bg-yellow-100 text-yellow-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded-md dark:bg-yellow-900 dark:text-yellow-300">รออนุมัติ</span>
                                                @break

                                                @case(2)
                                                    <span
                                                        class="bg-red-100 text-red-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded-md dark:bg-red-900 dark:text-red-300">ไม่อนุมัติ</span>
                                                @break

                                                @default
                                                    <span
                                                        class="bg-red-100 text-red-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded-md dark:bg-red-900 dark:text-red-300">ไม่พบสถานะ</span>
                                            @endswitch
                                        </td> --}}
