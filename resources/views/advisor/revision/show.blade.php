                                    ...
                                    @foreach ($invigilators as $inv)
                                        <tr
                                            ...
                                            <td class="px-6 py-3">{{ $inv['name'] }}
                                                @if ($inv['role'] == 1)
                                                    <span
                                                        class="bg-green-100 text-green-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-green-700 dark:text-green-300 truncate">อาจารย์ที่ปรึกษา</span>
                                                @elseif($inv['role'] == 2)
                                                    <span
                                                        class="bg-gray-100 text-gray-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded-full dark:bg-gray-700 dark:text-gray-300 truncate">กรรมการ</span>
                                                @endif
                                            </td>
                                            <td class="px-6 py-3 text-center">
                                                @switch($inv['status'])
                                                    ...
                                                    @case('1')
                                                        <span
                                                            class="px-2 py-0.5 bg-green-200 text-green-800 rounded-md truncate">อนุมัติแล้ว</span>
                                                    @break
                                                    ...
                                                    @default
                                                        <span
                                                            class="px-2 py-0.5 bg-gray-100 text-gray-800 rounded-md truncate">ไม่ทราบสถานะ</span>
                                                @endswitch
                                            </td>
                                        </tr>
                                    @endforeach
