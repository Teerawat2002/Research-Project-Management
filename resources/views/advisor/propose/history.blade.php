        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-50 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-xl font-bold text-gray-900 dark:text-gray-300">ประวัติเสนอหัวข้อ:
                        {{ $proposal->title }}</h3>
                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg rounded-lg mt-4">
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                    ...
                                    <tr
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            @elseif($record->status === 'approved')
                                                <span class="text-green-500">ได้รับการอนุมัติ</span>
                                            @else
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-6 py-4 text-center">ไม่พบประวัติ</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
